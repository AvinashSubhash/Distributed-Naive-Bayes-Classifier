...
if rank == 0:
    ...
    v1 = comm.sendrecv(df[temp[0]+["Class"]],dest=1,source=1)
    v2 = comm.sendrecv(df[temp[1]+["Class"]],dest=2,source=2)
    v3 = comm.sendrecv(df[temp[2]+["Class"]],dest=3,source=3)
    v4 = comm.sendrecv(df[temp[3]+["Class"]],dest=4,source=4)
